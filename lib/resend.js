...
export function getCredentialsEmailTemplate(name, username, password) {
  return `
    ...
    <head>
      ...
      <title>Your Login Credentials - BekerjaKeluarNegri.com</title>
      <style>
        * {
          margin: 0;
          padding: 0;
      ...
      <div class="email-container">
        <div class="header">
          <div class="logo">
            ...
            <div class="logo-text">BekerjaKeluarNegri.com</div>
          </div>
        ...
        <div class="content">
          ...
          <div class="action-button">
            <a href="https://bekerjakeluarnegri.com/login" target="_blank">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer">
          ...
          <p>&copy; ${new Date().getFullYear()} BekerjaKeluarNegri.com. All rights reserved.</p>
          <div class="footer-links">
            <a href="https://bekerjakeluarnegri.com">Website</a>
            <a href="mailto:support@bekerjakeluarnegri.com">Support</a>
            <a href="https://bekerjakeluarnegri.com/privacy">Privacy Policy</a>
          </div>
        </div>
      </div>
    </body>
